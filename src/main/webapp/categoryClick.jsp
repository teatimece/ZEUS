...
<head>
    ...
    <style>
        .bar_center{background: white;}
        .bar_bottom{background: white;}
    </style>
    <style>
@font-face {
...
%>
        ...
        <div class = "con_kate">
            ...
            <div class="category_item_box">
            	<%
            	for(HashMap product : cateProductList){
            	%>
                <div class="item_box">
                    <a href="productDetail.jsp?p_idx=<%=product.get("p_idx") %>" class="item">
                        ...
                        <div class="location_box">
                            <img src="img/번개장터이미지/위치.png"> <span><%=product.get("p_deallocation")%></span>
                        </div>
                    </a>
                </div>
    		<%
            ...
            <!-- <div class="category_paging_box">
                <div class="category_paging">
                    <a href="#" class="cate_paging_num"><img src="./img/번개장터이미지/좌측화살표.png"></a>
                    <a href="#" class="cate_paging_num">1</a>
                    <a href="#" class="cate_paging_num">2</a>
                    <a href="#" class="cate_paging_num">3</a>
                    <a href="#" class="cate_paging_num">4</a>
                    <a href="#" class="cate_paging_num">5</a>
                    <a href="#" class="cate_paging_num">6</a>
                    <a href="#" class="cate_paging_num">7</a>
                    <a href="#" class="cate_paging_num">8</a>
                    <a href="#" class="cate_paging_num">9</a>
                    <a href="#" class="cate_paging_num">10</a>
                    <a href="#" class="cate_paging_num"><img src="./img/번개장터이미지/우측화살표.png"></a>
                </div>
            </div> -->
        </div>
        </div>
