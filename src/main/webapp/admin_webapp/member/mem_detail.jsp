...
%>
                        <a href="./mem_products.jsp?m_idx=<%=m_idx%>"><img src="../images/더보기.png"><p>더보기</p></a>
<%
					}
%>
                        </div>
...
%>
                ...
                <div class="buttons">
                    ...
                    <p><input type="button" value="수정하기" onclick="location.href='./mem_detail_edit.jsp?m_idx=<%=member.getIdx()%>'"></p>
                    <p><input type="button" value="돌아가기" onclick="location.href='./mem_manage.jsp'"></p>
                </div>
                <div id ="popup_mask"></div>
                <div id="popupDiv"> <!-- 팝업창 -->
                	<form method="post" action="mem_block_ok.jsp?m_idx=<%=m_idx%>&&page=mem_detail">
                    <div>
