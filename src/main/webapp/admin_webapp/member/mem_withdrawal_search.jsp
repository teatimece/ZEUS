...
<%
	...
	List<MemberDTO> memberList = dao.withdrawSearchMember(mem_search, searchMem);
...
<%				
							String wdate = dao.getWdate(memberList.get(i).getIdx()); 
							String reason = dao.getReason(memberList.get(i).getIdx()); 
%> 
                            <td><%= wdate %></td>
                            <td><%= reason %></td>
