...
<%
	...
	List<MemberDTO> memberList = dao.blockSearchMember(mem_search, searchMem);
...
%>
						<tr>
                            ...
                            <td><a href="./mem_detail.jsp?m_idx=<%=memberList.get(i).getIdx()%>"><%=memberList.get(i).getUsername() %>(<%=memberList.get(i).getStore() %>의 상점)</a></td>
                            <td><%= proCnt %></td>
                            <td><%= memberList.get(i).getJoindate() %></td>
<%
							String blockdate = dao.getblockdate(memberList.get(i).getIdx()); 
							String blockreason = dao.getBlockreason(memberList.get(i).getIdx()); 
%>
							<td><%= blockdate %></td>
							<td><%= blockreason %></td>
