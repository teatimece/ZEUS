        ...
        <div class="contents">
            ...
            <div id="product_detail_edit">
                ...
                <div class="pro_detail1">
                    <table>
                        <tr>
                            ...
                            <th>상품명</th>
                            <td><input type="text" value="아이폰 12,12프로 실리콘케이스"></td>
                            <th>등록일</th>
                            <td>2021-02-18 12:27:51</td>
                        </tr>
                        <tr>
                            <th>가격</th>
                            <td><input type="text" value="4,000원"></td>
                            <th>거래지역</th>
                            <td>부산광역시 금정구 남산동</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <th>배송비</th>
                            <td><select>
                                <option value="배송비포함">배송비 포함</option>
                ...
                <div class="pro_detail2">
                    ...
                    <div class="conbox con1"><textarea>❤️ 아이폰 12/12pro 실리콘 케이스 입니다❤️
                        투명 실리콘 케이스입니당!
                        옆 라인에 색상 들어가있는 심플한 디자인의 케이스에용!
                        그린 퍼플 화이트 블랙 
                        총 4종류 있구용 모두 새제품입니다!
                        ...
                        교환 환불 어려우니 신중한 구매 부탁드려용😿)</textarea></div>
